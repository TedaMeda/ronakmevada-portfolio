...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    links: { live: "#", repo: "https://github.com/you/ecommerce" },
    date: "Jul 2023",
  },
  {
    id: "p5",
    ...
    image:
      "https://images.unsplash.com/photo-1611224923853-80b023f02d71?q=80&w=1600&auto=format&fit=crop",
    tags: ["React", "TypeScript", "Firebase", "Tailwind"],
    links: { live: "#", repo: "https://github.com/you/taskapp" },
    date: "Sep 2023",
  },
  {
    id: "p6",
    ...
    description:
      "A responsive weather dashboard with forecasts, charts, and location-based services.",
    image:
    ...
    links: { live: "#", repo: "https://github.com/you/weather" },
    date: "Nov 2023",
  },
];
...
const EXPERIENCES: Experience[] = [
  ...
  },
  {
    ...
    period: "2018 – 2019",
    description:
      "Created responsive web interfaces and implemented design systems for various client projects.",
  ...
  },
  {
    ...
    period: "2017 – 2018",
    description:
      "Provided technical assistance to customers and resolved software and hardware issues.",
...
export default function PortfolioApp() {
  ...
  const loadMoreExperiences = () => {
    setVisibleExperiences((prev) => prev + 5);
  };
        ...
        <div className="mt-6 grid sm:grid-cols-1 lg:grid-cols-2 gap-6">
          {filtered.slice(0, visibleProjects).map((p) => (
            <motion.div
              ...
              className="group"
            >
              <div className="relative overflow-hidden rounded-2xl border bg-card transition-all duration-300 hover:shadow-lg">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-5">
                    {p.tags.map((t) => (
                      <span
                        key={t}
                        className="px-3 py-1 text-xs rounded-full bg-secondary text-secondary-foreground border"
                      >
                        {t}
                      </span>
                    ))}
